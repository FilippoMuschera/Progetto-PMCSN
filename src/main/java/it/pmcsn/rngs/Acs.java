...
public class Acs {
    ...
    public void autocorrelation(String dir, String fileName) throws IOException {
        ...
        String line;
        InputStreamReader r = new InputStreamReader(new FileInputStream(new File(dir + "/" + fileName + ".dat")));
